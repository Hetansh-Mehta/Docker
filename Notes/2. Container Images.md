...
5. [Building Images: Running Docker Builds](#DockerBuilds)
6. [Building Images: Extending Official Images](#ExtendingImages)
7. [Building You Own Image](#BYO)
8. [Prune Commands](#prune)
...
*   Check this [Dockerfile](.//Dockerfile-Samples/dockerfile-assignment-1
    Dockerfile). Follow the instructions provided inside and build a dockerfile.
