...
- [1. What's in an Image? (And What Isn't) <a name="WhatIsInImage"></a>](#1-whats-in-an-image-and-what-isnt-)
- [2. Images and Their Layers <a name="ImageLayers"></a>](#2-images-and-their-layers-)
  - [2.1. Visualizing Layers <a name="VisualizingLayers"></a>](#21-visualizing-layers-)
  - [2.2. Container Layers <a name="ContainerLayers"></a>](#22-container-layers-)
- [3. Image Tagging and Upload to Docker Hub <a name="ImageTag"></a>](#3-image-tagging-and-upload-to-docker-hub-)
  - [3.1. Making New Tags <a name="NewTags"></a>](#31-making-new-tags-)
  - [3.2. Push To Docker Hub <a name="PushDockerHub"></a>](#32-push-to-docker-hub-)
- [4. Building Images: The Dockerfile Basics <a name="DockerfileBasics"></a>](#4-building-images-the-dockerfile-basics-)
- [5. Building Images: Running Docker Builds <a name="DockerBuilds"></a>](#5-building-images-running-docker-builds-)
- [6. Building Images: Extending Official Images <a name="ExtendingImages"></a>](#6-building-images-extending-official-images-)
- [7. Building You Own Image <a name="BYO"></a>](#7-building-you-own-image-)
- [8. Prune Commands <a name="prune"></a>](#8-prune-commands-)
...
# 5. Building Images: Running Docker Builds <a name="DockerBuilds"></a>
...
EXPOSE 80 443 8080
```
We notice that on each step, it says `Using cache`. It recognises that Step 6 is different, so it actually executes that into the container. It also re-runs Steps 7 because **the minute a line changes, every line after that now has to be rebuilt as well.**
...
# 6. Building Images: Extending Official Images <a name="ExtendingImages"></a>
...
# 7. Building You Own Image <a name="BYO"></a>
...
# 8. Prune Commands <a name="prune"></a>
