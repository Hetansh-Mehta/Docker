...
- [1. Creating and Using Containers](#1-creating-and-using-containers)
- [2. Docker Commands](#2-docker-commands)
- [3. Starting an Nginx Web Server](#3-starting-an-nginx-web-server)
  - [3.1. Image vs Container](#31-image-vs-container)
  - [3.2. Run/Stop/Remove Container](#32-runstopremove-container)
- [4. What happens when we run a container?](#4-what-happens-when-we-run-a-container)
- [5. Containers vs VM](#5-containers-vs-vm)
- [6. What's Going On In Containers](#6-whats-going-on-in-containers)
- [7. Getting a Shell Inside Containers](#7-getting-a-shell-inside-containers)
- [8. Docker Networks: Concepts and Management](#8-docker-networks-concepts-and-management)
  - [8.1. Concepts](#81-concepts)
  - [8.2. CLI Management](#82-cli-management)
  - [8.3. Docker Networks: Default Security](#83-docker-networks-default-security)
  - [8.4. Docker Network: DNS](#84-docker-network-dns)
...
* `docker info` <br>
    ...
    ![docker info](./Pictures/dockerInfo.png)
...
* `docker container run —publish 80:80 nginx` <br>
    ...
    ![docker publish](./Pictures/dockerPublish.png)
    ...
    ![refresh](./Pictures/detachCommandLine.png) <br>
...
* `docker container ls` <br>
    ...
    ![container ls](./Pictures/dockercontainerLS.png)

* `docker container stop <container_ID>` <br>
    Stops  the container matching the container id. <br>
    ![container stop](./Pictures/dockercontainerStop.png)
...
* `docker container ls -a` <br>
    ...
    ![container ls -a](./Pictures/dockerContainerLs-a.png)
...
* `docker container top <container_name>` <br>
    ...
    ![container top](./Pictures/dockerContainerTop.png) 
...
* `docker container inspect <container_name>` <br>
    ...
    ![container inspect](./Pictures/dockerContainerInspect.png)
...
* `docker container stats` <br>
    ...
    ![container stats](./Pictures/dockerContainerStats.png)
...
* `docker container run -it <image> [COMMANDS] [ARG...]` <br>
    ...
    ![container run -p](./Pictures/dockerContainerRunIT.png) 
...
* `docker container run -it --name ubuntu ubuntu` <br>
    ...
    ![container Ubuntu](./Pictures/dockerContainerRunUbuntu.png)<br>
...
![container start -ai](./Pictures/dockerContainerStartAI.png)
...
* `docker container exec [OPTIONS] CONTAINER COMMAND [ARG...]` <br>
    ...
    ![container exec](./Pictures/dockerContainerExec.png)
...
* Different Linux Distros in containers:
    - Alpine is a small security-focused distribution of Linux. <br>
    ![alpine](./Pictures/dockerAlpine.png)
    - When we give a `bash` command in Alpine, it gives an error:<br>
    ![alpine bash error](./Pictures/dockerAlpineBashError.png)
...
* `docker container run -p` <br>
    ...
    ![container run -p](./Pictures/dockerContainer-p-d--nameNginx.png)
...
* `docker container port CONTAINER [PRIVATE_PORT[/[PROTO]]` <br>
    ...
    ![container port](./Pictures/dockerContainerPort.png)
...
* `docker container inspect —format ‘{{.NetworkSettings.IPAddress}}’CONTAINER` <br>
    ...
    ![container inspect IP](./Pictures/dockerContainerInspectIP.png) <br>
...
![Network Diagram](./Pictures/NetworkDiagram.png) <br>
...
* `docker network inspect [OPTIONS] NETWORK [NETWORK...]` <br>
    ...
    ![Network inspect](./Pictures/dockerNetworkInspect.png)
...
* `docker network create [OPTIONS] NETWORK` <br>
    ...
    ![Network create --help](./Pictures/dockerNetworkCreate.png) <br>

    Let’s create a new network: <br>
    ![Network create](./Pictures/dockerNetworkCreate1.png)<br>
...
* `docker container run -d —name new_nginx —network my_app_net nginx` <br> 
    ...
    ![Network Inspect My_app_network](./Pictures/dockerNetworkInspect1.png) <br>
...
* `docker network disconnect [OPTIONS] NETWORK CONTAINER` <br>
    ...
    ![Network Connect/Disconnect](./Pictures/dockerNetworkConnect.png) <br>
...
![Network DNS](./Pictures/dockerNetworkDNSIntro.png) <br>
...
![Network DNS1](./Pictures/dockerNetworkDNSIntro1.png) <br>
...
* `docker container exec -it my_nginx ping new_host` <br>
    ...
    ![Network ping](./Pictures/DockerNetworkDNSPing.png) <br>
